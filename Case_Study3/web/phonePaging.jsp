...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
    <%
            ...
            int total = productDAO.getTotal(1);
            int totalpage;
            if(total > display){
                if(total%display == 0){
            ...
            listproduct = productDAO.getAllpaging(start, display,1);
                    	...
                    	<ul class="CS_page">
                            ...
                            for(int i = 1; i <= totalpage ; i++){
                                ...
                                value +="<li class='active'>"
										+"<span><a href='Home.jsp?phone="+i+"&laptop="+pglaptop+"&tablet="+pgtablet+"'>"+i+"</a></span>"
										+"</li>";
                                                               }else{
                                value +="<li>"
										+"<span><a href='Home.jsp?phone="+i+"&laptop="+pglaptop+"&tablet="+pgtablet+"'>"+i+"</a></span>"
