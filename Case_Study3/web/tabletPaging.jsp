<%-- 
    Document   : tabletPaging
    Created on : Nov 19, 2012, 7:42:13 PM
    Author     : Tung
--%>
...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
    <%
            ...
            listproduct = productDAO.getAllpaging(start, display,2);
                    	...
                    	<ul class="CS_page">
                            ...
                            for(int i = 1; i <= totalpage ; i++){
                                ...
                                value +="<li class='active'>"
										+"<span><a href='Home.jsp?phone="+pgphone+"&laptop="+pglaptop+"&tablet="+i+"'>"+i+"</a></span>"
										+"</li>";
                                                               }else{
                                value +="<li>"
										+"<span><a href='Home.jsp?phone="+pgphone+"&laptop="+pglaptop+"&tablet="+i+"'>"+i+"</a></span>"
